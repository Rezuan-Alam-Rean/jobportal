...
const Intdetails = () => {
    ...
    useEffect(() => {
        const findJob = details?.internships?.find((item) => item.id === id);
        setJob(findJob);
    }, [id, details]);
                ...
                <div className="card w-full md:w-[70%] h-full mx-auto">
                    <div className="banner flex flex-col md:flex-row justify-center items-center  gap-x-4 md:gap-x-28 bg-cover bg-center">
                        <div className="p-4 space-y-4">
                            <h1 className="text-2xl md:text-3xl mt-4 font-bold">
                    ...
                    <h1 className="text-3xl font-bold text-center mt-4 mb-3">Internship Details</h1>
